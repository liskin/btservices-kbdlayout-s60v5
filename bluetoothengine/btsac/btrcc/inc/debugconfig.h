...
* Contributors:
*
* Description:  Debug configure file.
*
*/
 ...
 */
 ...
 // BT Remote Controller panic codes
enum TBTRCCPanicCode 
    {
    EBtrccPanicNullPointer = 33300,
    EBtrccPanicPointerExists,
    EBtrccPanicAOIsActive,
    EBtrccPanicUnexpectedRemote, // the given remote BD address not matched
...
_LIT(KLogFile,"btrcc.txt");
_LIT(KLogDir,"BT");
#endif

#ifdef PRJ_ENABLE_TRACE
_LIT(KTracePrefix16, "[BTRCC] ");
_LIT8(KTracePrefix8, "[BTRCC] ");
