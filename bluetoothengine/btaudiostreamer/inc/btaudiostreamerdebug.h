...
* Contributors:
*
* Description:  Debug definitions for BT Audio Streamer
*
*/


#ifndef BTAUDIOSTREAMER_DEBUG_H
#define BTAUDIOSTREAMER_DEBUG_H
...
_LIT(KLogFile,"BTAudioStreamerLog.txt");
...
#define BT_AUDIO_STREAMER_TRACE_OPT(a,p) {if((KDebugMask)&(a))p;}
...
inline void FPrint(const TRefByValue<const TDesC> aFmt, ...)
    ...
    RFileLogger::WriteFormat(KLogDir, KLogFile, EFileLoggingModeAppend, _L("[BTAudioStreamer]\t MEM\tAllocated from heap: %d B. Total heap size: %d B"), size, User::Heap().Size());
#endif
    }
...
#define BT_AUDIO_STREAMER_TRACE_OPT(a,p)

#endif // ...loggings 

#endif // BTAUDIOSTREAMER_DEBUG_H
