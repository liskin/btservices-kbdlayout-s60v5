...
#ifndef SU8DANISHNORWEGIAN_H
#define SU8DANISHNORWEGIAN_H
...
class CSu8DanishNorwegianLayout : public CDeadKeyLayout
    {
public:

    static CKeyboardLayout* NewL();

    // Handle the minor differences between the Danish/Norwegian and
    // Finnish/Swedish layouts:
