...
const TInt CBelgianLayout::KColumnMap[] =
    {
    THidModifier::EUnmodified,  // ----
    THidModifier::EShift        // ---S
    };

const TUint16 CBelgianLayout::KKeyCodes[] = 
    {
    ...
    0x0009, 0x0009,  // 0x2b  43  Tab
       ...
       '^', 0x00a8,  // 0x2f  47  [ {
       '$',    '*',  // 0x30  48  ] }
    0x00b5, 0x00a3,  // 0x31  49  US \ bar
    0x00b5, 0x00a3,  // 0x32  50  # ~
       'm',    'M',  // 0x33  51  ; :
    0x00f9,    '%',  // 0x34  52  ' @
    0x00b2, 0x00b3,  // 0x35  53  Grave/not/bar
       ';',    '.',  // 0x36  54  , <
       ':',    '/',  // 0x37  55  . >
       '=',    '+',  // 0x38  56  / ?
...
const CStandardKeyboardLayout::TSpecialKey CBelgianLayout::KSpecialCases[] =
    {
    ...
    { 0x1e, THidModifier::EAltCtrl,      0x007c }, // 1 !
    { 0x1f, THidModifier::EAltCtrl,      0x0040 }, // 2 "
    { 0x20, THidModifier::EAltCtrl,      0x0023 }, // 3 £
    { 0x21, THidModifier::EAltCtrl,      0x007b }, // 4 $
    { 0x22, THidModifier::EAltCtrl,      0x005b }, // 5 %
    { 0x23, THidModifier::EAltCtrl,      0x005e }, // 6 ^
    { 0x26, THidModifier::EAltCtrl,      0x007b }, // 9 (
    { 0x27, THidModifier::EAltCtrl,      0x007d }, // 0 )
    { 0x2f, THidModifier::EAltCtrl,      0x005b }, // [ {
    { 0x30, THidModifier::EAltCtrl,      0x005d }, // ] }
    { 0x31, THidModifier::EAltCtrl,      0x0060 }, // US \ bar
    { 0x32, THidModifier::EAltCtrl,      0x0060 }, // # ~
    { 0x34, THidModifier::EAltCtrl,      0x00b4 }, // ' @
    { 0x38, THidModifier::EAltCtrl,      0x007e }, // / ?
    { 0x4c, THidModifier::EAltCtrl,      0xf844 }, // Delete
    { 0x63, THidModifier::EAltCtrl,      0xf844 }, // Keypad . Delete
    { 0x64, THidModifier::EAltCtrl,      0x005c }, // \ | (near left shift)
    { 0x31, THidModifier::EAltCtrlShift, 0x0060 }, // US \ bar
    { 0x32, THidModifier::EAltCtrlShift, 0x0060 }, // # ~
    { 0x34, THidModifier::EAltCtrlShift, 0x00b4 }, // ' @
    { 0x38, THidModifier::EAltCtrlShift, 0x007e }, // / ?
...
//
const CDeadKeyLayout::TKeyPair CBelgianLayout::KDeadKeyCircumflex[] =
    {
    { 0x0020, 0x005e },    // space
    { 0x0041, 0x00c2 },    // A
    { 0x0045, 0x00ca },    // E
...
// 0x00a8 (Diaeresis)
//
const CDeadKeyLayout::TKeyPair CBelgianLayout::KDeadKeyDiaeresis[] =
    {
    { 0x0020, 0x00a8 },    // space
    { 0x0041, 0x00c4 },    // A
    { 0x0045, 0x00cb },    // E
...
// 0x00b4 (Acute accent)
//
const CDeadKeyLayout::TKeyPair CBelgianLayout::KDeadKeyAcute[] =
    {
    { 0x0020, 0x00b4 },    // space
    { 0x0041, 0x00c1 },    // A
    { 0x0045, 0x00c9 },    // E
...
// 0x0060 (Grave accent)
//
const CDeadKeyLayout::TKeyPair CBelgianLayout::KDeadKeyGrave[] =
    {
    { 0x0020, 0x0060 },    // space
    { 0x0041, 0x00c0 },    // A
    { 0x0045, 0x00c8 },    // E
...
// 0x007e (Tilde)
//
const CDeadKeyLayout::TKeyPair CBelgianLayout::KDeadKeyTilde[] =
    {
    { 0x0020, 0x007e },    // space
    { 0x0041, 0x00c3 },    // A
    { 0x004e, 0x00d1 },    // N
...
const CDeadKeyLayout::TIndexPair CBelgianLayout::KDeadKeyIndex[] =
    {
...
TBool CBelgianLayout::ChangesWithCapsLock(TInt aHidKey,
...
TInt CBelgianLayout::LayoutId() const
    {
    DBG(RDebug::Print(_L("[HID]\tCBelgianLayout::LayoutId()")));
    return EBelgian;
    }

CKeyboardLayout* CBelgianLayout::NewL()
    {
    DBG(RDebug::Print(_L("[HID]\tCBelgianLayout::NewL()")));
    CKeyboardLayout* layout = new (ELeave) CBelgianLayout;
    return layout;
    }
