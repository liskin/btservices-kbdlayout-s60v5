...
const TInt CDanishLayout::KColumnMap[] =
    {
    THidModifier::EUnmodified,  // ----
    THidModifier::EShift        // ---S
    };

const TUint16 CDanishLayout::KKeyCodes[] = 
    {
    ...
    0x00a8,    '^',  // 0x30  48  ] }
      '\'',    '*',  // 0x31  49  US \ bar
      '\'',    '*',  // 0x32  50  # ~
    0x00e6, 0x00c6,  // 0x33  51  ; :
    0x00f8, 0x00d8,  // 0x34  52  ' @
    0x00bd, 0x00a7,  // 0x35  53  Grave/not/bar
       ',',    ';',  // 0x36  54  , <
       '.',    ':',  // 0x37  55  . >
       '-',    '_',  // 0x38  56  / ?
...
const CStandardKeyboardLayout::TSpecialKey CDanishLayout::KSpecialCases[] =
    {
    ...
    { 0x2e, THidModifier::EAltCtrl,   0x007c }, // = +
...
//
const CDeadKeyLayout::TKeyPair CDanishLayout::KDeadKeyCircumflex[] =
    {
    { 0x0020, 0x005e },    // space
    { 0x0041, 0x00c2 },    // A
    { 0x0045, 0x00ca },    // E
...
// 0x00a8 (Diaeresis)
//
const CDeadKeyLayout::TKeyPair CDanishLayout::KDeadKeyDiaeresis[] =
    {
    { 0x0020, 0x00a8 },    // space
    { 0x0041, 0x00c4 },    // A
    { 0x0045, 0x00cb },    // E
...
// 0x00b4 (Acute accent)
//
const CDeadKeyLayout::TKeyPair CDanishLayout::KDeadKeyAcute[] =
    {
    { 0x0020, 0x00b4 },    // space
    { 0x0041, 0x00c1 },    // A
    { 0x0045, 0x00c9 },    // E
...
// 0x0060 (Grave accent)
//
const CDeadKeyLayout::TKeyPair CDanishLayout::KDeadKeyGrave[] =
    {
    { 0x0020, 0x0060 },    // space
    { 0x0041, 0x00c0 },    // A
    { 0x0045, 0x00c8 },    // E
...
// 0x007e (Tilde)
//
const CDeadKeyLayout::TKeyPair CDanishLayout::KDeadKeyTilde[] =
    {
    { 0x0020, 0x007e },    // space
    { 0x0041, 0x00c3 },    // A
    { 0x004e, 0x00d1 },    // N
...
const CDeadKeyLayout::TIndexPair CDanishLayout::KDeadKeyIndex[] =
    {
...
TBool CDanishLayout::ChangesWithCapsLock(TInt aHidKey,
...
TInt CDanishLayout::LayoutId() const
    {
    DBG(RDebug::Print(_L("[HID]\tCDanishLayout::LayoutId()")));
    return EDanish;
    }

CKeyboardLayout* CDanishLayout::NewL()
    {
    DBG(RDebug::Print(_L("[HID]\tCDanishLayout::NewL()")));
    CKeyboardLayout* layout = new (ELeave) CDanishLayout;
    return layout;
    }
