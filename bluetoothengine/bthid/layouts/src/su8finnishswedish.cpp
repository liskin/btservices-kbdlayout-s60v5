...
const TInt CSu8FinnishSwedishLayout::KColumnMap[] =
    {
...
const TUint16 CSu8FinnishSwedishLayout::KKeyCodes[] = 
    {
    //----    ---S    -AC-   // Hex  Dec
         0,      0,      0,  // 0x00   0
         0,      0,      0,  // 0x01   1
...
const CStandardKeyboardLayout::TSpecialKey 
    CSu8FinnishSwedishLayout::KDanishKeyCodes[] =
    {
...
const CStandardKeyboardLayout::TSpecialKey 
    CSu8FinnishSwedishLayout::KSpecialCases[] =
    {
...
// 0x00b4 (Acute accent)
//
const CDeadKeyLayout::TKeyPair CSu8FinnishSwedishLayout::KDeadKeyAcute[] =
    {
    { 0x0020, 0x00b4 },    // space
    { 0x0041, 0x00c1 },    // A
    { 0x0045, 0x00c9 },    // E
...
// 0x0060 (Grave accent)
//
const CDeadKeyLayout::TKeyPair CSu8FinnishSwedishLayout::KDeadKeyGrave[] =
    {
    { 0x0020, 0x0060 },    // space
    { 0x0041, 0x00c0 },    // A
    { 0x0045, 0x00c8 },    // E
...
// 0x00a8 (Diaeresis)
//
const CDeadKeyLayout::TKeyPair CSu8FinnishSwedishLayout::KDeadKeyDiaeresis[] =
    {
    { 0x0020, 0x00a8 },    // space
    { 0x0041, 0x00c4 },    // A
    { 0x0045, 0x00cb },    // E
...
//
const CDeadKeyLayout::TKeyPair CSu8FinnishSwedishLayout::KDeadKeyCircumflex[] =
    {
    { 0x0020, 0x005e },    // space
    { 0x0041, 0x00c2 },    // A
    { 0x0045, 0x00ca },    // E
...
// 0x007e (Tilde)
//
const CDeadKeyLayout::TKeyPair CSu8FinnishSwedishLayout::KDeadKeyTilde[] =
    {
    { 0x0020, 0x007e },    // space
    { 0x0041, 0x00c3 },    // A
    { 0x004e, 0x00d1 },    // N
...
const CDeadKeyLayout::TIndexPair CSu8FinnishSwedishLayout::KDeadKeyIndex[] =
    {
...
CSu8FinnishSwedishLayout::CSu8FinnishSwedishLayout()
...
TBool CSu8FinnishSwedishLayout::ChangesWithCapsLock(TInt aHidKey,
...
TInt CSu8FinnishSwedishLayout::RawScanCode(TInt aHidKey, 
...
TInt CSu8FinnishSwedishLayout::LayoutId() const
    {
    DBG(RDebug::Print(_L("[HID]\tCSu8FinnishSwedishLayout::LayoutId()")));
    return ESu8FinnishSwedish;
    }

CKeyboardLayout* CSu8FinnishSwedishLayout::NewL()
    {
    DBG(RDebug::Print(_L("[HID]\tCSu8FinnishSwedishLayout::NewL()")));
    CKeyboardLayout* layout = new (ELeave) CSu8FinnishSwedishLayout;
    return layout;
    }
