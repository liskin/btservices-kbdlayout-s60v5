...
const TInt CPortugueseLayout::KColumnMap[] =
    {
    THidModifier::EUnmodified,  // ----
    THidModifier::EShift        // ---S
    };

const TUint16 CPortugueseLayout::KKeyCodes[] = 
    {
    ...
    0x0009, 0x0009,  // 0x2b  43  Tab
       ' ',    ' ',  // 0x2c  44  Spacebar
      '\'',    '?',  // 0x2d  45  - _
    0x00ab, 0x00bb,  // 0x2e  46  = +
       '+',    '*',  // 0x2f  47  [ {
    0x00b4,    '`',  // 0x30  48  ] }
       '~',    '^',  // 0x31  49  US \ bar
       '~',    '^',  // 0x32  50  # ~
    0x00e7, 0x00c7,  // 0x33  51  ; :
    0x00ba, 0x00aa,  // 0x34  52  ' @
...
const CStandardKeyboardLayout::TSpecialKey CPortugueseLayout::KSpecialCases[] =
    {
    ...
    { 0x21, THidModifier::EAltCtrl,   0x00a7 }, // 4 $
    ...
    { 0x2f, THidModifier::EAltCtrl,   0x00a8 }, // [ {
...
// 0x00a8 (Diaeresis)
//
const CDeadKeyLayout::TKeyPair CPortugueseLayout::KDeadKeyDiaeresis[] =
    {
    { 0x0020, 0x00a8 },    // space
    { 0x0041, 0x00c4 },    // A
    { 0x0045, 0x00cb },    // E
...
// 0x00b4 (Acute accent)
//
const CDeadKeyLayout::TKeyPair CPortugueseLayout::KDeadKeyAcute[] =
    {
    { 0x0020, 0x00b4 },    // space
    { 0x0041, 0x00c1 },    // A
    { 0x0045, 0x00c9 },    // E
...
// 0x0060 (Grave accent)
//
const CDeadKeyLayout::TKeyPair CPortugueseLayout::KDeadKeyGrave[] =
    {
    { 0x0020, 0x0060 },    // space
    { 0x0041, 0x00c0 },    // A
    { 0x0045, 0x00c8 },    // E
...
// 0x007e (Tilde)
//
const CDeadKeyLayout::TKeyPair CPortugueseLayout::KDeadKeyTilde[] =
    {
    { 0x0020, 0x007e },    // space
    { 0x0041, 0x00c3 },    // A
    { 0x004e, 0x00d1 },    // N
...
//
const CDeadKeyLayout::TKeyPair CPortugueseLayout::KDeadKeyCircumflex[] =
    {
    { 0x0020, 0x005e },    // space
    { 0x0041, 0x00c2 },    // A
    { 0x0045, 0x00ca },    // E
...
const CDeadKeyLayout::TIndexPair CPortugueseLayout::KDeadKeyIndex[] =
    {
...
CPortugueseLayout::CPortugueseLayout()
...
TBool CPortugueseLayout::ChangesWithCapsLock(TInt aHidKey,
    ...
    if (aModifiers.None() || aModifiers.ShiftOnly())
        ...
        //
        TBool isExtraCapsKey = (aHidKey == 0x33);    // ; :
...
TInt CPortugueseLayout::LayoutId() const
    {
    DBG(RDebug::Print(_L("[HID]\tCPortugueseLayout::LayoutId()")));
    return EPortuguese;
    }

CKeyboardLayout* CPortugueseLayout::NewL()
    {
    DBG(RDebug::Print(_L("[HID]\tCPortugueseLayout::NewL()")));
    CKeyboardLayout* layout = new (ELeave) CPortugueseLayout;
    return layout;
    }
