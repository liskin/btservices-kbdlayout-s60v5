...
const TInt CSpanishLayout::KColumnMap[] =
    {
    THidModifier::EUnmodified,  // ----
    THidModifier::EShift        // ---S
    };

const TUint16 CSpanishLayout::KKeyCodes[] = 
    {
    ...
    0x0009, 0x0009,  // 0x2b  43  Tab
       ' ',    ' ',  // 0x2c  44  Spacebar
      '\'',    '?',  // 0x2d  45  - _
    0x00a1, 0x00bf,  // 0x2e  46  = +
       '`',    '^',  // 0x2f  47  [ {
       '+',    '*',  // 0x30  48  ] }
    0x00e7, 0x00c7,  // 0x31  49  US \ bar
    0x00e7, 0x00c7,  // 0x32  50  # ~
    0x00f1, 0x00d1,  // 0x33  51  ; :
    0x00b4, 0x00a8,  // 0x34  52  ' @
    0x00ba, 0x00aa,  // 0x35  53  Grave/not/bar
       ',',    ';',  // 0x36  54  , <
       '.',    ':',  // 0x37  55  . >
       '-',    '_',  // 0x38  56  / ?
...
const CStandardKeyboardLayout::TSpecialKey CSpanishLayout::KSpecialCases[] =
    {
    ...
    { 0x21, THidModifier::EAltCtrl,   0x007e }, // 4 $
    { 0x22, THidModifier::EAltCtrl,   0x20ac }, // 5 %
    { 0x23, THidModifier::EAltCtrl,   0x00ac }, // 6 ^
    { 0x2f, THidModifier::EAltCtrl,   0x005b }, // [ {
    { 0x30, THidModifier::EAltCtrl,   0x005d }, // ] }
    { 0x31, THidModifier::EAltCtrl,   0x007d }, // US \ bar
    { 0x32, THidModifier::EAltCtrl,   0x007d }, // # ~
    { 0x34, THidModifier::EAltCtrl,   0x007b }, // ' @
    { 0x35, THidModifier::EAltCtrl,   0x005c }, // Grave/not/bar
...
// 0x007e (Tilde)
//
const CDeadKeyLayout::TKeyPair CSpanishLayout::KDeadKeyTilde[] =
    {
    { 0x0020, 0x007e },    // space
    { 0x0041, 0x00c3 },    // A
    { 0x004e, 0x00d1 },    // N
...
// 0x0060 (Grave accent)
//
const CDeadKeyLayout::TKeyPair CSpanishLayout::KDeadKeyGrave[] =
    {
    { 0x0020, 0x0060 },    // space
    { 0x0041, 0x00c0 },    // A
    { 0x0045, 0x00c8 },    // E
...
//
const CDeadKeyLayout::TKeyPair CSpanishLayout::KDeadKeyCircumflex[] =
    {
    { 0x0020, 0x005e },    // space
    { 0x0041, 0x00c2 },    // A
    { 0x0045, 0x00ca },    // E
...
// 0x00b4 (Acute accent)
//
const CDeadKeyLayout::TKeyPair CSpanishLayout::KDeadKeyAcute[] =
    {
    { 0x0020, 0x00b4 },    // space
    { 0x0041, 0x00c1 },    // A
    { 0x0045, 0x00c9 },    // E
...
// 0x00a8 (Diaeresis)
//
const CDeadKeyLayout::TKeyPair CSpanishLayout::KDeadKeyDiaeresis[] =
    {
    { 0x0020, 0x00a8 },    // space
    { 0x0041, 0x00c4 },    // A
    { 0x0045, 0x00cb },    // E
...
const CDeadKeyLayout::TIndexPair CSpanishLayout::KDeadKeyIndex[] =
    {
...
TBool CSpanishLayout::ChangesWithCapsLock(TInt aHidKey,
...
TInt CSpanishLayout::LayoutId() const
    {
    DBG(RDebug::Print(_L("[HID]\tCSpanishLayout::LayoutId()")));
    return ESpanish;
    }

CKeyboardLayout* CSpanishLayout::NewL()
    {
    DBG(RDebug::Print(_L("[HID]\tCSpanishLayout::NewL()")));
    CKeyboardLayout* layout = new (ELeave) CSpanishLayout;
    return layout;
    }
