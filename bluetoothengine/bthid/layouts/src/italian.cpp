...
const TInt CItalianLayout::KColumnMap[] =
    {
    THidModifier::EUnmodified,  // ----
    THidModifier::EShift        // ---S
    };

const TUint16 CItalianLayout::KKeyCodes[] = 
    {
    ...
    0x0009, 0x0009,  // 0x2b  43  Tab
      ...
      '\'',    '?',  // 0x2d  45  - _
    0x00ec,    '^',  // 0x2e  46  = +
    0x00e8, 0x00e9,  // 0x2f  47  [ {
       '+',    '*',  // 0x30  48  ] }
    0x00f9, 0x00a7,  // 0x31  49  US \ bar
    0x00f9, 0x00a7,  // 0x32  50  # ~
    0x00f2, 0x00e7,  // 0x33  51  ; :
    0x00e0, 0x00b0,  // 0x34  52  ' @
...
const CStandardKeyboardLayout::TSpecialKey CItalianLayout::KSpecialCases[] =
    {
    ...
    { 0x33, THidModifier::EAltCtrl,      0x0040 }, // ; :
    { 0x34, THidModifier::EAltCtrl,      0x0023 }, // ' @
    { 0x4c, THidModifier::EAltCtrl,      0xf844 }, // Delete
    { 0x63, THidModifier::EAltCtrl,      0xf844 }, // Keypad . Delete
    { 0x2f, THidModifier::EAltCtrlShift, 0x007b }, // [ {
    { 0x30, THidModifier::EAltCtrlShift, 0x007d }, // ] }
...
TInt CItalianLayout::LayoutId() const
    {
    DBG(RDebug::Print(_L("[HID]\tCItalianLayout::LayoutId()")));
    return EItalian;
    }

CKeyboardLayout* CItalianLayout::NewL()
    {
    DBG(RDebug::Print(_L("[HID]\tCItalianLayout::NewL()")));
    CKeyboardLayout* layout = new (ELeave) CItalianLayout;
    return layout;
    }
