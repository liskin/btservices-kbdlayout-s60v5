...
const TInt CGermanLayout::KColumnMap[] =
    {
    THidModifier::EUnmodified,  // ----
    THidModifier::EShift        // ---S
    };

const TUint16 CGermanLayout::KKeyCodes[] = 
    {
    ...
    0x00df,    '?',  // 0x2d  45  - _
    0x00b4,    '`',  // 0x2e  46  = +
    0x00fc, 0x00dc,  // 0x2f  47  [ {
       '+',    '*',  // 0x30  48  ] }
       '#',   '\'',  // 0x31  49  US \ bar
       '#',   '\'',  // 0x32  50  # ~
    0x00f6, 0x00d6,  // 0x33  51  ; :
    0x00e4, 0x00c4,  // 0x34  52  ' @
       '^', 0x00b0,  // 0x35  53  Grave/not/bar
       ',',    ';',  // 0x36  54  , <
       '.',    ':',  // 0x37  55  . >
       '-',    '_',  // 0x38  56  / ?
...
const CStandardKeyboardLayout::TSpecialKey CGermanLayout::KSpecialCases[] =
    {
    ...
    { 0x14, THidModifier::EAltCtrl,   0x0040 }, // q Q
    { 0x1f, THidModifier::EAltCtrl,   0x00b2 }, // 2 "
    { 0x20, THidModifier::EAltCtrl,   0x00b3 }, // 3 £
...
// 0x00b4 (Acute accent)
//
const CDeadKeyLayout::TKeyPair CGermanLayout::KDeadKeyAcute[] =
    {
    { 0x0020, 0x00b4 },    // space
    { 0x0041, 0x00c1 },    // A
    { 0x0045, 0x00c9 },    // E
...
// 0x0060 (Grave accent)
//
const CDeadKeyLayout::TKeyPair CGermanLayout::KDeadKeyGrave[] =
    {
    { 0x0020, 0x0060 },    // space
    { 0x0041, 0x00c0 },    // A
    { 0x0045, 0x00c8 },    // E
...
//
const CDeadKeyLayout::TKeyPair CGermanLayout::KDeadKeyCircumflex[] =
    {
    { 0x0020, 0x005e },    // space
    { 0x0041, 0x00c2 },    // A
    { 0x0045, 0x00ca },    // E
...
const CDeadKeyLayout::TIndexPair CGermanLayout::KDeadKeyIndex[] =
    {
...
TBool CGermanLayout::ChangesWithCapsLock(TInt aHidKey,
...
TInt CGermanLayout::LayoutId() const
    {
    DBG(RDebug::Print(_L("[HID]\tCGermanLayout::LayoutId()")));
    return EGerman;
    }

CKeyboardLayout* CGermanLayout::NewL()
    {
    DBG(RDebug::Print(_L("[HID]\tCGermanLayout::NewL()")));
    CKeyboardLayout* layout = new (ELeave) CGermanLayout;
    return layout;
    }
