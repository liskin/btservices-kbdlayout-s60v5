...
const CStandardKeyboardLayout::TSpecialKey CUSInternationalLayout::KSpecialCases[] =
    {
...
//
const CDeadKeyLayout::TKeyPair CUSInternationalLayout::KDeadKeyCircumflex[] =
    {
    { 0x0020, 0x005e },    // space
    { 0x0041, 0x00c2 },    // A
    { 0x0045, 0x00ca },    // E
...
// 0x0027 (Apostrophe)
//
const CDeadKeyLayout::TKeyPair CUSInternationalLayout::KDeadKeyApostrophe[] =
    {
    { 0x0020, 0x0027 },    // space
    { 0x0041, 0x00c1 },    // A
    { 0x0043, 0x00c7 },    // C
...
//
const CDeadKeyLayout::TKeyPair CUSInternationalLayout::KDeadKeyQuotationMark[] =
    {
    { 0x0020, 0x0022 },    // space
    { 0x0041, 0x00c4 },    // A
    { 0x0045, 0x00cb },    // E
...
// 0x0060 (Grave accent)
//
const CDeadKeyLayout::TKeyPair CUSInternationalLayout::KDeadKeyGrave[] =
    {
    { 0x0020, 0x0060 },    // space
    { 0x0041, 0x00c0 },    // A
    { 0x0045, 0x00c8 },    // E
...
// 0x007e (Tilde)
//
const CDeadKeyLayout::TKeyPair CUSInternationalLayout::KDeadKeyTilde[] =
    {
    { 0x0020, 0x007e },    // space
    { 0x0041, 0x00c3 },    // A
    { 0x004e, 0x00d1 },    // N
...
const CDeadKeyLayout::TIndexPair CUSInternationalLayout::KDeadKeyIndex[] =
    {
...
CUSInternationalLayout::CUSInternationalLayout()
...
TBool CUSInternationalLayout::ChangesWithCapsLock(TInt aHidKey,
...
TInt CUSInternationalLayout::LayoutId() const
    {
    DBG(RDebug::Print(_L("[HID]\tCUSInternationalLayout::LayoutId()")));
    return EUSInternational;
    }

CKeyboardLayout* CUSInternationalLayout::NewL()
    {
    DBG(RDebug::Print(_L("[HID]\tCUSInternationalLayout::NewL()")));
    CKeyboardLayout* layout = new (ELeave) CUSInternationalLayout;
    return layout;
    }
