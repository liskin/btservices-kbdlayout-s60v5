...
const TInt CFrenchLayout::KColumnMap[] =
    {
    THidModifier::EUnmodified,  // ----
    THidModifier::EShift        // ---S
    };

const TUint16 CFrenchLayout::KKeyCodes[] = 
    {
    ...
    0x0009, 0x0009,  // 0x2b  43  Tab
       ...
       '^', 0x00a8,  // 0x2f  47  [ {
       '$', 0x00a3,  // 0x30  48  ] }
       '*', 0x00b5,  // 0x31  49  US \ bar
       '*', 0x00b5,  // 0x32  50  # ~
       'm',    'M',  // 0x33  51  ; :
    0x00f9,    '%',  // 0x34  52  ' @
    0x00b2,      0,  // 0x35  53  Grave/not/bar
       ';',    '.',  // 0x36  54  , <
       ':',    '/',  // 0x37  55  . >
       '!', 0x00a7,  // 0x38  56  / ?
...
const CStandardKeyboardLayout::TSpecialKey CFrenchLayout::KSpecialCases[] =
    {
    ...
    { 0x1f, THidModifier::EAltCtrl,   0x007e }, // 2 "
    { 0x20, THidModifier::EAltCtrl,   0x0023 }, // 3 £
    { 0x21, THidModifier::EAltCtrl,   0x007b }, // 4 $
    { 0x22, THidModifier::EAltCtrl,   0x005b }, // 5 %
    { 0x23, THidModifier::EAltCtrl,   0x007c }, // 6 ^
    { 0x24, THidModifier::EAltCtrl,   0x0060 }, // 7 &
    { 0x25, THidModifier::EAltCtrl,   0x005c }, // 8 *
    { 0x26, THidModifier::EAltCtrl,   0x005e }, // 9 (
    { 0x27, THidModifier::EAltCtrl,   0x0040 }, // 0 )
    { 0x2d, THidModifier::EAltCtrl,   0x005d }, // - _
    { 0x2e, THidModifier::EAltCtrl,   0x007d }, // = +
    { 0x30, THidModifier::EAltCtrl,   0x00a4 }, // ] }
...
// 0x007e (Tilde)
//
const CDeadKeyLayout::TKeyPair CFrenchLayout::KDeadKeyTilde[] =
    {
    { 0x0020, 0x007e },    // space
    { 0x0041, 0x00c3 },    // A
    { 0x004e, 0x00d1 },    // N
...
// 0x0060 (Grave accent)
//
const CDeadKeyLayout::TKeyPair CFrenchLayout::KDeadKeyGrave[] =
    {
    { 0x0020, 0x0060 },    // space
    { 0x0041, 0x00c0 },    // A
    { 0x0045, 0x00c8 },    // E
...
//
const CDeadKeyLayout::TKeyPair CFrenchLayout::KDeadKeyCircumflex[] =
    {
    { 0x0020, 0x005e },    // space
    { 0x0041, 0x00c2 },    // A
    { 0x0045, 0x00ca },    // E
...
// 0x00a8 (Diaeresis)
//
const CDeadKeyLayout::TKeyPair CFrenchLayout::KDeadKeyDiaeresis[] =
    {
    { 0x0020, 0x00a8 },    // space
    { 0x0041, 0x00c4 },    // A
    { 0x0045, 0x00cb },    // E
...
const CDeadKeyLayout::TIndexPair CFrenchLayout::KDeadKeyIndex[] =
    {
...
TBool CFrenchLayout::ChangesWithCapsLock(TInt aHidKey,
...
TInt CFrenchLayout::LayoutId() const
    {
    DBG(RDebug::Print(_L("[HID]\tCFrenchLayout::LayoutId()")));
    return EFrench;
    }

CKeyboardLayout* CFrenchLayout::NewL()
    {
    DBG(RDebug::Print(_L("[HID]\tCFrenchLayout::NewL()")));
    CKeyboardLayout* layout = new (ELeave) CFrenchLayout;
    return layout;
    }
