...
// Logging path
_LIT( KBtAudioTestSystemLogPath, "e:\\logs\\btengapitest\\" );
// Log file
_LIT( KBtAudioTestSystemLogFile, "BtEngApiTestLog.html" );
// Log file
_LIT( KBtAudioTestSystemLogFullName, "\\logs\\btengapitest\\BtEngApiTestLog_%x.html" );
