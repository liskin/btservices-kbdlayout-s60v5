...
// Logging path
_LIT( KBtApiTestLogPath, "\\logs\\LC\\BTEng\\" ); 
// Log file
_LIT( KBtApiTestLogFile, "BTEngSettingsApiTest.txt" ); 
...
NONSHARABLE_CLASS(CBtApiTest) : public CScriptBase, public MBTTestObserver
    ...
    private:
        ...
        * @return Symbian OS error code.
        */
        virtual TInt CBTEngSettings_GetAndSetPowerState ( CStifItemParser& aItem );
        ...
        virtual TInt CBTEngSettings_GetOfflineModeSettingsApi ( CStifItemParser& aItem );
        virtual TInt CBTEngSettings_ChangePowerStateTemporarily ( CStifItemParser& aItem );
